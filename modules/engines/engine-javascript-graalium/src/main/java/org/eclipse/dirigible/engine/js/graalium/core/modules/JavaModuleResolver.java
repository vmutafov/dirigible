 ...
 */
package org.eclipse.dirigible.engine.js.graalium.core.modules;

import org.eclipse.dirigible.engine.js.graalium.core.modules.java.JavaPackageProxyGenerator;
...
public class JavaModuleResolver implements ModuleResolver{
    ...
    public Path resolve(String moduleToResolve) {
        ...
        try {
            FileUtils.write(javaPackageProxyGeneratedFile, coreModuleContent, StandardCharsets.UTF_8);
        } catch (IOException e) {
